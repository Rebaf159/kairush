<template>
  <div>
    ...
    <div class="text-center mb-6">
      <h2 class="text-2xl font-bold text-white mb-2">Hoş Geldin</h2>
      <p class="text-gray-400">Hesabına giriş yap ve yoldaşlarınla buluş</p>
    </div>
    ...
    <form @submit.prevent="handleLogin" class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <button
          type="button"
          class="text-sm text-primary-400 hover:text-primary-300 transition-colors duration-300"
          :disabled="authStore.loading"
        >
          Şifremi unuttum
        </button>
...
import { EyeIcon, EyeSlashIcon, ArrowRightOnRectangleIcon } from '@heroicons/vue/24/outline'
...
const handleLogin = async () => {
  try {
    await authStore.login({
      username: form.email, // FastAPI OAuth2PasswordRequestForm username alanını bekler
